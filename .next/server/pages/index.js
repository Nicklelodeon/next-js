...
function MeetupItem(props) {
    ...
    function showDetailsHandler() {
        // push a new page onto stack of pages, equivalent to using Link
...
async function getStaticProps() {
    // fetch data from API
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://nicholascheong2618:Inaymmm2618@cluster0.jyw8gxz.mongodb.net/?retryWrites=true&w=majority");
    const db = client.db();
